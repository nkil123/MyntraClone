...
add_to_bag.innerHTML='<ion-icon name="bag"></ion-icon>'+" " +"ADD TO BAG";
...
wish_list.innerHTML='<ion-icon name="heart-outline"></ion-icon>'+" "+"WISHLIST";
...
pin_1.textContent="Please enter PIN code to check delivery time & Pay on Delivery Availability";
...
pin_pro_1.innerHTML='<ion-icon name="train-outline"></ion-icon>'+" " + "Get it by Tue, Nov 25";
pin_pro_2.innerHTML='<ion-icon name="cash-outline"></ion-icon>'+" "+ "Pay on delivery available";
pin_pro_3.innerHTML='<ion-icon name="arrow-undo-outline"></ion-icon>'+" "+"Easy 7 days return & exchange available";
...
best_2.textContent="Coupon Discount: Rs. 300 off (check cart for final savings)";
best_2.style.fontSize="20px";
let best_3=document.createElement("li");
best_3.textContent="Applicable on: Orders above Rs. 1999 (only on first purchase)";
...
div.append(brand_product,title_product,div_2,hr,div_3,all_taxes, size_chart_22,sizes,add_to_bag,wish_list,deliv_x,box_01,pin_1, qualaity_pro,quality_max,pin_pro,best_offer_both,best_1,best_2,best_3,hr,pro_detail_11,description_product,size_color,size_des,care_mat,care_mat_1,spe);
